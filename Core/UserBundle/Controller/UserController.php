...
class UserController extends Controller
{
    ...
    private function createCreateForm(User $entity)
    {
        ...
        $form->add('submit', 'submit', array('label' => $translator->trans('crud.user.btn.create'), 'attr' => array("class" => "btn-success pull-right ")));
        $form->add('submit_and_mail', 'submit', array('label' => $translator->trans('crud.user.btn.create_and_mail'), 'attr' => array("class" => "btn-success pull-right ")));
    ...
    private function createEditForm(User $entity)
    {
        ...
        $translator = $this->get('translator');
        $form->add('submit', 'submit', array('label' => $translator->trans('crud.user.btn.update'), 'attr' => array("class" => "btn-info pull-right ")));
        $form->add('submit_and_mail', 'submit', array('label' => $translator->trans('crud.user.btn.update_and_mail'), 'attr' => array("class" => "btn-success pull-right top5 ")));
